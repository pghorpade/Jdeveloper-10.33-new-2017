 ...
 * @author Henry Chiong (hchiong@library.ucla.edu)
 */
public class LoggableStatement implements PreparedStatement {
     ...
     * @throws java.sql.SQLException if a <code>PreparedStatement</code> cannot be created
     *                               using the supplied <code>connection</code> and <code>sql</code>
     */
    public LoggableStatement(Connection connection, 
     ...
     * The driver will ignore the array if the given SQL statement is not an INSERT statement.
     *
     * @param sql         any SQL statement
     * @param columnNames an array of the names of the columns in the inserted row that should be made available for retrieval by a call to the method getGeneratedKeys
     * @return true if the next result is a ResultSet object; false if it is an update count or there are no more results
     * @throws java.sql.SQLException if a database access error occurs or the elements of the String array passed to this method are not valid column names
     */
    public boolean execute(String sql, 
     ...
     *
     * @param sql           an SQL INSERT, UPDATE or DELETE statement or an SQL statement that returns nothing, such as an SQL DDL statement
     ...
     * @throws java.sql.SQLException if a database access error occurs, the SQL statement returns a ResultSet object, or the
     *                               second argument supplied to this method is not an int array whose elements are valid column indexes
     */
    public int executeUpdate(String sql, 
     ...
     * @return either the row count for INSERT, UPDATE, or DELETE statements, or 0 for SQL statements that return nothing
     * @throws java.sql.SQLException if a database access error occurs, the SQL statement returns a ResultSet object, or the second argument supplied to this method is not a String array whose elements are valid column names
     */
    public int executeUpdate(String sql, 
                             String[] columnNames) throws SQLException {
    ...
    public void setByte(int parameterIndex, 
        ...
        saveQueryParamValue(parameterIndex, (int)x);
    }
     ...
     * <p>
     * <p><strong>Note:</strong> This stream object can either be a standard
     * Java stream object or your own subclass that implements the
     * standard interface.
     *
     * @param parameterIndex the first parameter is 1, the second is 2, ...
