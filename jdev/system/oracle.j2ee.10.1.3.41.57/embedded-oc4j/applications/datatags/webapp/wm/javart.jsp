...
<HEAD> 
  <TITLE><%= wm.getLabel("JAVA_RT_PARAS") %></TITLE> 
</HEAD> 

<uix:stackLayout> 
<uix:contents> 
  <uix:header text="<%= wm.getLabel(\"JAVA_RT_PARAS\") %>"> 
  <uix:contents> 
     ...
     <uix:contents> 
        <uix:rowLayout hAlign="top"> 
          <uix:contents> 
             <uix:table id="javaRuntimeDataTable" > 
             <%
                wm.showJavaRuntimeParameter(javaRuntimeDataTable);
             %>
             </uix:table>
          </uix:contents> 
        </uix:rowLayout> 
