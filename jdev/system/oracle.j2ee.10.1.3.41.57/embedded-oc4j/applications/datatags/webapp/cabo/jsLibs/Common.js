...
{
if(_agent.isSafari&&(a3=="IMG"))
{
var a4=["align","alt","border","height","id","longDesc",
"name","src","title","width","x","y"];
for(var a5 in a4)
{
var a6=a4[a5];
a1[a6]=a2[a6];
...
if(a9||a10)
{
var a11=a0.createElement(a3);
a11.mergeAttributes(a2,false);
if(a9)
{
a11.innerHTML=a2.innerHTML;
}
else
{
if(a10)
{
var a12=a2.firstChild;
while(a12!=null)
{
while(a12!=null&&a12.tagName=="!")
{
a12=a12.nextSibling;
}
a11.appendChild(_setOuterHTML(a0,
null,
a12));
a12=a12.nextSibling;
}
...
if(a1)
{
a1.parentNode.replaceChild(a11,a1);
}
else
{
a1=a11;
...
if(a3!='TR')
{
a11=a0.createElement(a3);
if(a3=='SELECT')
{
if(a2.multiple)
{
a11.multiple=a2.multiple;
}
for(var a13=0;a13<a2.options.length;a13++)
{
var a14=a2.options[a13];
var a15=new Option();
a15.value=a14.value;
a15.text=a14.text;
a15.selected=a14.selected;
a11.options[a13]=a15;
}
}
else
{
var a16=a2.innerHTML;
if((a16!=null)&&(a16.length>0))
{
a11.innerHTML=a2.innerHTML;
}
}
var a17=a2.attributes;
for(var a13=0;a13<a17.length;a13++)
{
a11.setAttribute(a17[a13].name,a17[a13].value);
}
}
else
{
a11=a0.importNode(a2,true);
}
a1.parentNode.insertBefore(a11,a1);
...
_uixspu(a0,a1,a2,a3,a4,a5,a6);
}
else
{
_pendingRadioButton=true;
var a7="_pendingRadioButton=false;_uixspu(";
if(a0!=null)
a7+="'"+a0+"'";
a7+=",";
a7+=a1;
