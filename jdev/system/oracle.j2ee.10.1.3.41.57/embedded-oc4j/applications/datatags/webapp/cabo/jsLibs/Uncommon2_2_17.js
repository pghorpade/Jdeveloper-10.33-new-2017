...
this.dataBeanId=a1;
this.isText=(a2=="TEXT_MODE");
this.maxLength=a3;
this.browserFlag=a4;
this.isIE=(this.browserFlag=="IE_Win");
this.isMozilla=(this.browserFlag=="Mozilla");
this.maxLengthAlertMsgStr="";
var a5=RichTextEditorProxy.prototype.familyOfRTEs;
var a6=a5.toString();
if(a6.indexOf(''+this)==-1)
{
RichTextEditorProxy.prototype.familyOfRTEs=RichTextEditorProxy.prototype.familyOfRTEs.concat(this);
}
}
...
{
var a0=document.getElementById(this.beanId);
...
{
return a0.getElementById(this.beanId).contentWindow;
}
